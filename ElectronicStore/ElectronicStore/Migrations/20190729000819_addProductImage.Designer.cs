...
namespace ElectronicStore.Migrations
{
    ...
    [Migration("20190729000819_addProductImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElectronicStore.Models.Appointments", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ElectronicStore.Models.CartItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ElectronicStore.Models.Appointments", b =>
                {
                    b.HasOne("ElectronicStore.Models.ApplicationUsers", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("AdminId");

                    b.HasOne("ElectronicStore.Models.ApplicationUsers", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId");

                    b.HasOne("ElectronicStore.Models.ApplicationUsers", "LatestUpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ElectronicStore.Models.Order", b =>
                {
                    b.HasOne("ElectronicStore.Models.Appointments", "Appointments")
                        .WithMany()
            ...
            modelBuilder.Entity("ElectronicStore.Models.ProductImage", b =>
                {
                    b.HasOne("ElectronicStore.Models.Products", "Product")
                        .WithMany("MoreImages")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
